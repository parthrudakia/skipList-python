...
print(f'The first insertion of 500,000 key-value pair takes {end1 - start1} seconds')
print(f'The second insertion of 200,000 key-value pair takes {end2 - start2} seconds')
print(f'The third insertion of 200,000 key-value pair takes {end3 - start3} seconds')
print(f'The fourth insertion of 200,000 key-value pair takes {end4 - start4} seconds')
print(f'The fifth insertion of 200,000 key-value pair takes {end5 - start5} seconds')
print(f'The sixth insertion of 200,000 key-value pair takes {end6 - start6} seconds\n')

avg_insertion = ((end2 - start2) + (end3 - start3) + (end4 - start4) + (end5 - start5) + (end6 - start6)) / 5
print(f'The Average Insertion time after 500,000 size SkipList is {avg_insertion} seconds for every 200,000 pairs')
...
print('Average Search Operation takes in a 1.5 Million size SkipList is :'+ "{:f}".format(avg_search)+' seconds\n\n')
...
print(f'Time taken for 100,000 ClosestKeyBefore operations : {end14-start14} seconds')
avg_ckb = ((end14-start14)/100000)
print('Average ClosestKeyBefore Operation takes in a 1.5 Million size SkipList is :'+ "{:f}".format(avg_ckb)+' seconds\n\n')
...
print(f'Time taken for 100,000 ClosestKeyAfter operations : {end15-start15} seconds')
avg_cka = ((end15-start15)/100000)
print('Average ClosestKeyAfter Operation takes in a 1.5 Million size SkipList is :'+ "{:f}".format(avg_cka)+' seconds\n\n')


# Printing time for deletion of every 200,000 pairs and clearing SkipList
print('Deletion\n')

print(f'The first deletion of 200,000 key-value pair from 1.5 Million size SkipList takes {end7 - start7} seconds')
print(f'The second deletion of 200,000 key-value pair from 1.3 Million size SkipList takes {end8 - start8} seconds')
print(f'The third deletion of 200,000 key-value pair from 1.1 Million size SkipList takes {end9 - start9} seconds')
print(f'The fourth deletion of 200,000 key-value pair from 0.9 Million size SkipList takes {end10 - start10} seconds')
print(f'The fifth deletion of 200,000 key-value pair from 0.7 Million size SkipList takes {end11 - start11} seconds\n')

avg_deletion = ((end7 - start7) + (end8 - start8) + (end9 - start9) + (end10 - start10) + (end11 - start11)) / 5
total_deletion = end12 - start7

print(f'The Average Deletion time taken from a 1.5 Million size SkipList is : {avg_deletion} seconds for every 200,000 pairs')
print(f'The total time taken to Delete a 1.5 Million size Skiplist is : {total_deletion} seconds')
